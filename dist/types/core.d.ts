 ...
 */
export type ModelName<Client> = string & keyof {
    [K in keyof Client as Client[K] extends {
        findMany: Function;
    } ? K : never]: true;
};
/**
 ...
 */
export type ModelField<Client, M extends ModelName<Client>> = Client[M] extends {
    findUnique: (...args: any[]) => Promise<infer Result>;
} ? Result extends null | undefined ? never : keyof Result : string;
/**
